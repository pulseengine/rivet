...
/// A YAML mapping in which the keys and values are both `rivet_yaml::Value`.
...
/// A type that can be used to index into a `rivet_yaml::Mapping`. See the
...
/// Iterator over `&rivet_yaml::Mapping`.
pub struct Iter<'a> {
...
/// Iterator over `&mut rivet_yaml::Mapping`.
...
/// Iterator over `rivet_yaml::Mapping` by value.
pub struct IntoIter {
...
/// Iterator of the keys of a `&rivet_yaml::Mapping`.
pub struct Keys<'a> {
...
/// Iterator of the values of a `&rivet_yaml::Mapping`.
pub struct Values<'a> {
...
/// Iterator of the values of a `&mut rivet_yaml::Mapping`.
