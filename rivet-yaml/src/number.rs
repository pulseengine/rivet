...
use crate::scalar as de; // RIVET: scalar resolution helpers, ported from de.rs
...
impl Number {
    ...
    /// let v: rivet_yaml::Value = rivet_yaml::from_str(r#"
    /// a: 64
    ...
    /// ```
    /// # fn main() -> rivet_yaml::Result<()> {
    /// let v: rivet_yaml::Value = rivet_yaml::from_str(".inf")?;
    /// assert_eq!(v.as_f64(), Some(f64::INFINITY));
    ///
    /// let v: rivet_yaml::Value = rivet_yaml::from_str("-.inf")?;
    /// assert_eq!(v.as_f64(), Some(f64::NEG_INFINITY));
    ///
    /// let v: rivet_yaml::Value = rivet_yaml::from_str(".nan")?;
